export default function KeyboardIcon() {
    return (
        ...
        >
            <path
                d="M11 28C11 26.8954 11.8954 26 13 26H67C68.1046 26 69 26.8954 69 28V36H11V28Z"
                fill="#F29145"
            />
            <path
                d="M11 64C11 65.1046 11.8954 66 13 66H67C68.1046 66 69 65.1046 69 64V56H11V64Z"
                fill="#EE701D"
            />
